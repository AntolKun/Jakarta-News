                                    ...
                                    <div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ url('admin/postsUser') }}" method="POST" enctype="multipart/form-data">
                                                {{ csrf_field() }}
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3 column">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input class="form-control" type="number" value="" id="no_telp" name="no_telp" />
                                                        </div>
                                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row-12">
                                                            ...
                                                            <form action="/admin/userDelete/{{ $u->id }}" method="POST">
                                                                @csrf
                                                                @method("DELETE")
