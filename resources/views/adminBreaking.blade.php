                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Breaking News</h4>
                                <div>
                                    <!-- center modal -->
                                    <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center">
                                        <i class="bx bx-smile font-size-16 align-middle me-2"></i>Tambah Breaking News</button>
                                    <div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Tambah Breaking News</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>

                                                <form action="{{ url('admin/postsBreaking') }}" method="POST" enctype="multipart/form-data">
                                                {{ csrf_field() }}
                                                <div class="modal-body">
                                                    <div class="mb-3 column">
                                                        <label for="breaking" class="col-md-2 col-form-label">Judul Breaking News</label>
                                                        <div class="col-md-12">
                                                            <input class="form-control" type="text" value="" id="breaking" name="breaking" />
                                                        </div>
                                                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Manajemen Breaking News</h4>
                                    <p class="card-title-desc">Semua Breaking News yang terdaftar muncul disini
                                    </p>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row-12">
                                                            ...
                                                            <form action="/admin/breakingDelete/{{ $bkg->id }}" method="POST">
                                                                @csrf
                                                                @method("DELETE")
