...
<!-- Mirrored from infynews.infyom.com/p/indian-american-neal-mohan-is-new-youtube-ceo by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Feb 2023 16:13:19 GMT -->
<!-- Added by HTTrack -->
                    ...
                    <div class="row">
                        <div class="col-xl-8">
                            ...
                            <section class="sports-left-section">
                                ...
                                <div class="row pt-60">
                                    <div class="col-lg-5 sports-content-img">
                                        <div class="sports-img position-relative">
                                            <a href="../../p/inside-a-maya-village-where-locals-live-without-power-and-fight-to-preserve-their-culture.html">
                                                <img src="{{ url('posts/', $post->gambar) }}" class="w-100 h-100" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-lg-7 ps-xl-4">
                                        <div class="text pt-lg-0 pt-4">
                                            <h3 class="text-black fw-7 mb-xxl-3 mb-xl-0 mb-lg-3 ">
                                                <a href="../../p/inside-a-maya-village-where-locals-live-without-power-and-fight-to-preserve-their-culture.html" class="text-black">
                                                    {{ $post->judul }}
                                                </a>
                                            </h3>
                                            ...
                                            <div class="desc d-flex flex-wrap">
                                                <span class="fs-12 text-black">By {{ $post->user }}</span>
                                                <span class="fs-12 text-primary mx-2"> | </span>
                                                <span class="fs-12 text-black">{{ $post->tanggal }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Livewire Component wire-end:pVccjhlg1XNfISBva41z -->
                            </section>
                            ...
                            <section class="popular-news-section">
                                ...
                                <div class="popular-news-post">
                                    <div class="row">
                                        <div class="col-xl-12 d-flex flex-wrap justify-content-between">
                                            <div class="col-xl-12 col-sm-6 card d-flex flex-xl-row py-20 pe-xl-0 pe-lg-4 pe-sm-3">
                                                @foreach ($postpopuler as $pp)
                                                <div class="row">
                                                    <div class="col-xl-4 col-5 card-top">
                                                        <div class="card-img-top">
                                                            <a href="{{ route('readBerita', $pp->slug) }}">
                                                                <img src="{{ url('posts/', $pp->gambar) }}" alt="" class="w-100 h-100 w-300px">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-8 col-7">
                                                        <div class="card-body ">
                                                            <h5 class="card-title mb-1 fs-12 text-gray fw-7">{{ $pp->kategori }}
                                                            </h5>
                                                            <p class="card-title mb-0 fs-14 text-black fw-6">
                                                                <a href="{{ route('readBerita', $pp->slug) }}" class="text-black">
                                                                    {{ $pp->judul }}
                                                                </a>
                                                            </p>
                                                            <span class="card-text fs-12 text-gray">{{ $pp->tanggal }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                @endforeach
...
<!-- Mirrored from infynews.infyom.com/p/indian-american-neal-mohan-is-new-youtube-ceo by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Feb 2023 16:13:24 GMT -->
